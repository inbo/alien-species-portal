...
RUN R -q -e "remotes::install_version('commonmark', version = '1.8.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('fastmap', version = '1.1.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('lattice', version = '0.20-45', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('proxy', version = '0.4-27', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('sourcetools', version = '0.1.7', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('wk', version = '0.7.1', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('xfun', version = '0.36', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('xml2', version = '1.3.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('xtable', version = '1.8-4', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('yaml', version = '2.3.6', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('processx', version = '3.8.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('sp', version = '1.5-1', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('terra', version = '1.6-47', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('callr', version = '3.7.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('e1071', version = '1.7-12', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('htmltools', version = '0.5.4', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('lubridate', version = '1.9.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('raster', version = '3.6-13', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('rgdal', version = '1.6-4', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('blob', version = '1.2.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('classInt', version = '0.4-8', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('httpuv', version = '1.6.8', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('webshot', version = '0.5.4', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('gargle', version = '1.2.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('sf', version = '1.0-9', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('dplyr', version = '1.0.10', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('forcats', version = '0.5.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('ggplot2', version = '3.4.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('googledrive', version = '2.0.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('rmarkdown', version = '2.19', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('vroom', version = '1.6.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('dbplyr', version = '2.2.1', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('dtplyr', version = '1.2.2', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('readr', version = '2.1.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('readxl', version = '1.4.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('shinyjs', version = '2.1.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('broom', version = '1.0.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('modelr', version = '0.1.10', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('tidyverse', version = '1.3.2', upgrade = FALSE)" && \
