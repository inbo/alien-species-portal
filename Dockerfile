...
RUN R -q -e "remotes::install_version('leaflet.providers', version = '1.13.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('lifecycle', version = '1.0.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('sp', version = '2.1-0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('systemfonts', version = '1.0.5', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('terra', version = '1.7-46', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('timechange', version = '0.2.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('tinytex', version = '0.47', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('knitr', version = '1.44', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('raster', version = '3.6-23', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('vctrs', version = '0.6.3', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('httr', version = '1.4.7', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('webshot', version = '0.5.5', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('testthat', version = '3.2.0', upgrade = FALSE)" && \
