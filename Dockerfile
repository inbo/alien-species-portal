...
RUN R -q -e "remotes::install_version('lifecycle', version = '1.0.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('sp', version = '2.0-0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('systemfonts', version = '1.0.4', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('terra', version = '1.7-39', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('units', version = '0.8-3', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('knitr', version = '1.43', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('httpuv', version = '1.6.11', upgrade = FALSE)" && \
